...
const OCPage: React.FC = () => {
  ...
  const [columnHeaders, setColumnHeaders] = useState<string[]>(['Campo 1', 'Campo 2', 'Campo 3', 'Campo 4', 'Campo 5', 'Campo 6', 'Campo 7', 'Campo 8']);

  const addRow = () => {
    setFormData([...formData, Object.fromEntries(columnHeaders.map(header => [header, '']))]);
  };

  const addColumn = () => {
    const newColumnHeader = prompt('Ingrese el nombre de la nueva columna') || '';
